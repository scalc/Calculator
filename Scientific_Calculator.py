...
e.grid(row=0,column=0,columnspan=5,padx=20,pady=20,ipady=12)
...
button1=Button(root,text="1",padx=34,pady=20,command=lambda:click(1),bg="black",fg="white",font=('Segoe UI',20))
...
button4=Button(root,text="4",padx=34,pady=20,command=lambda:click(4),bg="black",fg="white",font=('Segoe UI',20))
...
button7=Button(root,text="7",padx=34,pady=20,command=lambda:click(7),bg="black",fg="white",font=('Segoe UI',20))
...
button0=Button(root,text="0",padx=34,pady=20,command=lambda:click(0),bg="black",fg="white",font=('Segoe UI',20))
...
button_per=Button(root,text="%",padx=37,pady=20,command=per,bg="tan",fg="black",font=('Segoe UI',20))
button_sin=Button(root,text="sin",padx=26,pady=20,command=sin,bg="tan",fg="black",font=('Segoe UI',20))
