...
__copyright__ = "Copyright (C) 2020 ABBAS"
...
print("        To get rights to copy/make chnages mail to suhebabbasm@gmail.com     ")
...
root.title("SCIENTIFIC CALCULATOR ~ ABBAS PRODUCTIONS")
